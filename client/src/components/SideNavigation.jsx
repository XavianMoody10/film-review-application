...
export const SideNavigation = () => {
  ...
  return (
    <motion.aside
      ...
      className=" p-5 bg-linear-to-b from-black to-gray-900 fixed left-0 top-0 h-screen w-full min-[400px]:max-w-[350px] border-r border-gray-60000 shadow-2xl z-20 space-y-4"
    >
      <X
        color="white"
        size={25}
